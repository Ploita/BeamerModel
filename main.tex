...
\title{Análise do Treinamento de Redes Neurais Profundas no Paradigma de 
Aprendizado por Reforço Através do Plano de Informação}
...
\begin{center}
    \includegraphics[height=1.25cm]{af-logotipo-feec-horizontal-positivo.png}\hfill
    \includegraphics[height=1.25cm]{logo.pdf}\hfill
\end{center}
\begin{center}
    \includegraphics[height=2.5cm]{unicamp-logotipo.pdf}
\end{center}
...
% Adicionando Autor e Instituição
\begin{center}
    {\large \insertauthor} \\
\end{center}
...
\begin{frame}[plain]{Índice} %todo transformar em índice
    \tableofcontents
\end{frame}
